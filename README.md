...
Ứng dụng camera web dùng cử chỉ tay để tạo khung kính 3D trực tiếp trên video, kèm trình chỉnh sửa ảnh với ghép collage, khung viền, sticker và chữ.

## Tính năng chính

- **Nhận diện cử chỉ tay** qua MediaPipe Hands: tam giác, tứ giác 3D (hai chữ L), vòng tròn (hai tay), trái tim.
