...
const effectsCloseBtnEl = document.getElementById('effects-close-btn');
const effectsTabButtons = effectsSheetEl ? Array.from(effectsSheetEl.querySelectorAll('.effects-tab')) : [];
const effectsPanels = effectsSheetEl ? Array.from(effectsSheetEl.querySelectorAll('.effects-panel')) : [];
